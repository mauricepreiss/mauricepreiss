...
For 1 1/2 years now I have been learning the profession of an application development specialist in the field of desktop and API development in C# .NET. I program hobby C# projects, reprogram already existing programs, improve existing projects and rewrite already existing projects / programs better.
